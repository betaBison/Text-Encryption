...
def check_version(secret,num_decryption):
    ...
    if version_encrypt != version_decrypt:
        display_iterations(secret,False, num_decryption)
...
def display_iterations(final_message,auto_mode,num_decryption):
...
def decrypt(secret,auto_mode):
    ...
    while True:
        ...
        if is_integer(secret[0:2]) == True:        
            ...
            num_decryption += 1
            display_iterations(final_message,auto_mode,num_decryption)
