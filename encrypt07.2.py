...
def main():
    ...
    while run_code == 'y' or run_code == 'r':
        message = input_secret(run_code,final_message)
        [run_code,final_message] = encrypt(message)
...
def input_secret(run_code,final_message):  
    if run_code == 'r':
...
def encrypt(message):            
    ...
    run_code = input("Enter anything else (or nothing) to close the program: ")
